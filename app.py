...
train_data = train_data[['serial', 'ID', 'ProdID', 'Rating', 'ReviewCount', 'Category', 'Brand', 'Name', 'ImageURL', 'Description', 'Tags']]
...
def content_based_recommendations(train_data, item_name, top_n=10):
    ...
    print(type(train_data['Tags'].iloc[0]))
    tfidf_matrix_content = tfidf_vectorizer.fit_transform(train_data['Tags'].values.astype('U'))
    print(train_data['Tags'])
    ...
    print("Item Index is: ****", item_index)

    # Get the cosine similarity scores for the item
    similar_items = list(enumerate(cosine_similarities_content[item_index]))
    print("First Similar Items", similar_items)

    # Sort similar items by similarity score in descending order
    print("**************-Second Similar Items***************", similar_items)
    ...
    # print("Train Data ILOC******\n",train_data.iloc[recommended_item_indices])
